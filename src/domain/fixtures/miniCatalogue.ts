...
const races: readonly Race[] = [
  {
    ...
    facts: ['+2 au choix', '7,50 m', 'Vision dans le noir'],
    abilityBonuses: {},
    size: 'M',
    speed: 7.5,
    darkvision: 18,
    ...
    choices: [
      {
        ...
        help: 'Tu places toi-même le bonus de ton peuple.',
        pick: 1,
        bonus: 2,
        from: ABILITIES,
      },
  ...
  },
  {
    ...
    facts: ['+2 et deux +1 au choix', '9 m', 'Deux compétences au choix'],
    abilityBonuses: {},
    size: 'M',
    speed: 9,
    darkvision: 18,
